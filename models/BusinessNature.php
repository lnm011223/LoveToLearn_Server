...
class MerchantIntention extends BaseModel {
    ...
    public function rules() {
        ...
        return array(
            ...
            array('type_huiyuan,merchant_name,merchant_nature,merchant_address,business_end_time,business_start_time,merchant_num,merchant_detail_address,business_license,contact_GF_account,contact_name,contact_phone,contact_email,intention_state','safe'),
        );
    }
